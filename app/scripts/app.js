      ...
      data: function () {
        return {
          ...
          dropdown1: {
            ...
            classes: "",
            size: "md",
            title: " (Unregistered DecSoft App Builder - https://www.davidesperalta.com/)",
            direction: "dropup",
            tabIndex: 0,
            text: "Παννελήνιο Σχολικό Δικτυο",
            kind: "primary",
            leftIcon: "",
            rightIcon: "",
            leftBadge: "",
            ...
            rightAligned: false,
            event: null,
            itemClickHandler: function (event, item, index) {
              var
            ...
            appendItem: function (text, actived, disabled) {
              this.items.push({"class": app.dropdownItem.item, "text": text, "actived": actived, "disabled": disabled});
            },
            appendHeader: function (text) {
              this.items.push({"class": app.dropdownItem.header, "text": text, "actived": false, "disabled": false});
            },
            appendDivider: function () {
              this.items.push({"class": app.dropdownItem.divider, "text": "", "actived": false, "disabled": false});
            },
            insertItem: function (index, text, actived, disabled) {
              if (this.items.length < index) { return false; }
              this.items.splice(index, 0, {"class": app.dropdownItem.item, "text": text, "actived": actived, "disabled": disabled});
            },
            insertHeader: function (index, text) {
              if (this.items.length < index) { return false; }
              this.items.splice(index, 0, {"class": app.dropdownItem.header, "text": text, "actived": false, "disabled": false});
            },
            insertDivider: function (index) {
              if (this.items.length < index) { return false; }
              this.items.splice(index, 0, {"class": app.dropdownItem.divider, "text": "", "actived": false, "disabled": false});
            },
          ...
          checkbox1: {
            name: "checkbox1",
            value: false,
            text: "www.sch.gr ΠΣΔ MinDigital",
            classes: "",
            title: " (Unregistered DecSoft App Builder - https://www.davidesperalta.com/)",
            tabIndex: 0,
            hidden: false,
          ...
          textarea1: {
            name: "textarea1",
            value: "MS Teams ή Webex. MS Team is better",
            size: "sm",
            classes: "",
            title: " (Unregistered DecSoft App Builder - https://www.davidesperalta.com/)",
            placeholder: "",
          ...
          checkbox3: {
            name: "checkbox3",
            value: false,
            text: "www.microsoft.com/teams Micorsoft",
            classes: "",
            title: " (Unregistered DecSoft App Builder - https://www.davidesperalta.com/)",
            tabIndex: 0,
            hidden: false,
          ...
          textarea2: {
            name: "textarea2",
            value: "ZOOM is For Geeks\nFor Vac Rendevouz renedvac19.netlify.app\nFor Chat pc-chat-pctechgr.netlify.app",
            size: "sm",
            classes: "",
            title: " (Unregistered DecSoft App Builder - https://www.davidesperalta.com/)",
            placeholder: "",
...
window.app = new Vue({
  ...
  data: function () {
    ...
    return {
      ...
      version: "1.0.0",
      name: "Time For TeleSchool (Unregistered DecSoft App Builder - https://www.davidesperalta.com/)",
      shortName: "Sch !!",
      description: "Time For TeleSchool !!",
  ...
  methods: {
	...
	showAlert: function (body, title, kind, buttons, closeCallback) {
	  ...
	  $('#dab-alert-modal').on('hidePrevented.bs.modal', function () {
